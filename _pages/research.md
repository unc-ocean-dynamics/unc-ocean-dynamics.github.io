...
<img src="/assets/images/dns_turbulence_3d.png" alt="Three-dimensional vorticity structures from a direct numerical simulation of ice-ocean boundary layer turbulence" width="360">
<img src="/assets/images/dns_boundary_profiles.png" alt="Vertical profiles of velocity, vorticity, temperature, salinity, and melt rate from a direct numerical simulation of the ice-ocean boundary layer" width="360">
...
![Idealized glacial fjord model setup showing overturning and recirculation](/assets/images/fjordsetup_grl.png)
...
<img src="/assets/images/modelgeom7.png" alt="Model geometry of an ice-shelf cavity with a bathymetric sill" width="600">
...
![Idealized simulation of submesoscale eddies generated beneath an Antarctic sea-ice lead](/assets/images/antarctic_leads.png)
...
<img src="/assets/images/coastal_gulfstream_speed.png" alt="Surface current speed from a high-resolution US East Coast model showing the Gulf Stream jet and eddies" width="420">
<img src="/assets/images/coastal_sst.png" alt="Surface temperature from a high-resolution US East Coast model showing the warm Gulf Stream along the coast" width="420">

See the [Movies](/movies/) page for animations of the Gulf Stream and shelf circulation.
...
<img src="/assets/images/lab_laser_experiment.png" alt="Laser-sheet visualization of flow in a laboratory ice-ocean boundary layer experiment" width="360">
<img src="/assets/images/fluids_lab.png" alt="The Joint Fluids Laboratory wave-tank facility at UNC Chapel Hill" width="360">
